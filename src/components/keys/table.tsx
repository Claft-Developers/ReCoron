...
import { Copy, Trash2, CheckCircle2, XCircle, Clock, ChevronLeft, ChevronRight, Edit } from "lucide-react";
import { formatDate } from "@/utils/date";
import { EditKeyModal } from "@/components/modals/edit-key-modal";
...
export function APIKeysTable({ apiKeys }: Props) {
    ...
    return (
        ...
        {/* 編集モーダル */}
        {editingKey && (
            <EditKeyModal apiKey={editingKey} onClose={closeEditModal} />
        )}
    </>
    );
}