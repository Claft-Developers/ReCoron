                ...
                <div className="mx-auto w-full max-w-md">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-sm text-muted-foreground">
                            すでにアカウントをお持ちですか？{" "}
                            <Link href="/login" className="text-foreground font-medium underline underline-offset-4 hover:text-primary">
                                ログイン
                            </Link>
                        </p>
                    </div>
                    ...
                    <p className="mt-6 text-xs text-muted-foreground">
                        ...
                        ,{" "}
                        <Link href="/acceptable-use" className="underline underline-offset-4 hover:text-foreground">
                            Acceptable Use
                        </Link>
                        , and{" "}
            ...
            <div className="hidden lg:block relative bg-muted">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center space-y-4 p-8">
                        ...
                        <h2 className="text-3xl font-bold">開発者のための<br />Cron Job サービス</h2>
